...
print(f'Original image dtype: {img_np.dtype}')
...
print(f'Chars unique values: {np.unique(chars)[:10]}')
...
with open('e:/my_pro/test_correct_result.txt', 'w', encoding='utf-8') as f:
    f.write(result_text)

print(f'Saved test result to e:/my_pro/test_correct_result.txt')
